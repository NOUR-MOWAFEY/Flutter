...
class AskarPostPray extends StatefulWidget {
  const AskarPostPray({super.key});

  @override
  State<AskarPostPray> createState() => _AzkarElsabahState();
}

class _AzkarElsabahState extends State<AskarPostPray> {
  ...
  Future<void> loadAzkar() async {
    String jsonString = await rootBundle.loadString('assets/zekrFile3.json');
